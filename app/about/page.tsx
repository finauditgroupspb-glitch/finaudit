...
export const metadata: Metadata = {
  title: "О компании",
  description:
    "AUDIT D — команда аудиторов, бухгалтеров, налоговых консультантов и юристов. История, ценности и принципы работы компании.",
  ...
  return (
    <>
      <PageHero
        ...
        lead="Компания AUDIT D выросла из аудиторской практики. Годы проверок показали нам, как выглядит учёт, которому нельзя верить, — и мы построили компанию, которая делает наоборот."
      />
          ...
          <Reveal variant="left">
            ...
            <div className="mt-6 space-y-4 text-[1rem] leading-relaxed text-graphite/85">
              ...
              <p>
                ...
                Сегодня AUDIT D закрывает финансовую и правовую функцию бизнеса целиком:
